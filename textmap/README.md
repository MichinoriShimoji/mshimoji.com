...
- 「札幌」「箱根」「博多」のような裸形（市・町・村・区を落とした形）も検出。
  一般語や人名と紛らわしい語幹（中央・本部・山田など）は正式名のみ対応
...
> 国土数値情報（行政区域N03・鉄道N02・学校P29・医療機関P04）・地理院タイル、
> Geolonia住所データ、歴史的行政区域データセットβ版（CODH）を加工して作成
...
- 一部の集落座標（伊良部島の佐良浜など8地点）: 国土地理院「地理院タイル」の注記
  （居住地名）から取得（国土地理院コンテンツ利用規約に基づく利用）。
